-- Migrations must be applied in order on a clean d1_migrations tracking table; partial/hand-applied states are unsupported.
-- `os` is part of the table definition in
